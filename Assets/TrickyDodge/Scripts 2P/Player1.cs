...
public class Player1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (Input.GetKeyDown(KeyCode.UpArrow) && !isJumping && !iscrouhing)
            {
                Jump();
            }
            if (Input.GetKeyDown(KeyCode.DownArrow) && !iscrouhing && !isJumping)
            {
                Chroch();
            }
        }
        ...
        {
            if (Input.GetKeyDown(KeyCode.UpArrow) && !iscrouhing && !isJumping)
            {
                Chroch();
            }
            if (Input.GetKeyDown(KeyCode.DownArrow) && !isJumping && !iscrouhing)
            {
                Jump();
            }
        }
