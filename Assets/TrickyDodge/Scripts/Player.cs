...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!Gamecontroler.Instance.isSwitch)
        {
            if ((Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.W)) && !isJumping && !iscrouhing)
            {
                Jump();
            }
            if ((Input.GetKeyDown(KeyCode.DownArrow) || Input.GetKeyDown(KeyCode.S)) && !iscrouhing && !isJumping)
            {
                Chroch();
            }
        }
        ...
        {
            if ((Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.W)) && !iscrouhing && !isJumping)
            {
                Chroch();
            }
            if ((Input.GetKeyDown(KeyCode.DownArrow) || Input.GetKeyDown(KeyCode.S)) && !isJumping && !iscrouhing)
            {
                Jump();
            }
        }
